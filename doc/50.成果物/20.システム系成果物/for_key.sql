...
--
-- Host: localhost
-- Generation Time: 2019 年 5 月 24 日 05:06
...
ALTER TABLE `all_user_answers`
  ...
  ADD KEY `all_user_answers_answer_db_question_id_answer_number_fk` (`question_id`,`answer_choice`),
...
--
-- Indexes for table `answer_db`
--
ALTER TABLE `answer_db`
...
ALTER TABLE `exams_db`
  ADD PRIMARY KEY (`exam_id`,`exam_name`);
...
ALTER TABLE `exams_questions_db`
  ADD PRIMARY KEY (`exam_id`,`exams_number`,`question_id`,`question_number`),
...
--
-- AUTO_INCREMENT for table `all_user_answers`
--
ALTER TABLE `all_user_answers`
...
--
-- AUTO_INCREMENT for table `answer_db`
--
ALTER TABLE `answer_db`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `exams_db`
--
ALTER TABLE `exams_db`
  MODIFY `exam_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `exams_numbers_db`
--
ALTER TABLE `exams_numbers_db`
  MODIFY `exam_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `exams_questions_db`
--
ALTER TABLE `exams_questions_db`
  MODIFY `exam_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `genres_db`
--
ALTER TABLE `genres_db`
...
--
-- AUTO_INCREMENT for table `questions_db`
--
ALTER TABLE `questions_db`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `questions_genres_db`
--
ALTER TABLE `questions_genres_db`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `all_user_answers`
  ADD CONSTRAINT `all_user_answers_answer_db_question_id_answer_number_fk` FOREIGN KEY (`question_id`,`answer_choice`) REFERENCES `answer_db` (`question_id`, `answer_number`),
...
--
ALTER TABLE `answer_db`
  ADD CONSTRAINT `answer_db_questions_db_question_id_fk` FOREIGN KEY (`question_id`) REFERENCES `questions_db` (`question_id`);
...
--
ALTER TABLE `exams_questions_db`
  ADD CONSTRAINT `exams_questions_db_exams_numbers_db_exam_id_exams_number_fk` FOREIGN KEY (`exam_id`,`exams_number`) REFERENCES `exams_numbers_db` (`exam_id`, `exams_number`),
